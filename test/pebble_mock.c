...
uint32_t MESSAGE_KEY_WEATHER_HI_AT_TODAY = 126;
uint32_t MESSAGE_KEY_WEATHER_LO_AT_TODAY = 127;
uint32_t MESSAGE_KEY_WEATHER_HI_AT_TOMORROW = 128;
uint32_t MESSAGE_KEY_WEATHER_LO_AT_TOMORROW = 129;
