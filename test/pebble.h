...
extern uint32_t MESSAGE_KEY_WEATHER_HI_AT_TODAY;
extern uint32_t MESSAGE_KEY_WEATHER_LO_AT_TODAY;
extern uint32_t MESSAGE_KEY_WEATHER_HI_AT_TOMORROW;
extern uint32_t MESSAGE_KEY_WEATHER_LO_AT_TOMORROW;
